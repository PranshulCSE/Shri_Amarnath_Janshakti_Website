...
const ACTION_BTNS = [
  ...
  { href: 'C:\\Projects\\Front_End\\SAJSSM\\public\\Docs\\List of Bank Branches 2025.pdf',             icon: 'fas fa-university',  label: 'नामित बैंक', download: true },
  { href: '/Docs/CHC English 2025.pdf',                       icon: 'fas fa-file-medical',label: 'चिकित्सा फॉर्म डाउनलोड करें', download: true },
...
export default function YatraPage({ navigate }) {
  return (
    <>
      {/* Page Header */}
